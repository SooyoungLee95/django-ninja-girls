...
from ras.common.authentication.authentication import RideryoAuth
...
api = NinjaAPI(title="Rider API Service", description="Rider와 Shift를 관리하는 API 서비스", version="0.0.1", auth=RideryoAuth())
